        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{url('admin/arsip')}}"><button type="submit" class="btn btn-primary"><i class="fa fa-file-archive-o"></i><span> Arcive</span></button></a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <form role="form" action="{{url('admin/update-retensi/'.$data->id_dok)}}" method="POST">
                                    {{ csrf_field() }}
                                <td>
                                    <select name="status">
                                        @if($data->status == 'musnah' || $data->status == 'Musnah')
                                            <option selected="selected" value="{{$data->id}}">{{$data->status}}</option>
                                            <option value="4">ditinjau ulang</option>
                                        @elseif(($data->status == 'tinjau ulang' || $data->status == 'Ditinjau Ulang'))
                                            <option selected="selected" value="{{$data->id}}">{{$data->status}}</option>
