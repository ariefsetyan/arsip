            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{url('admin/update-dokumen')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 dynamic" style="width: 100%;" data-dependent="jenis" id="kode" name="kode" disabled>
                                        <option selected="selected" value="{{$data->id}}">{{$data->kode_pp}}.{{$data->kode_ap}}.{{$data->kode_p}}/{{$data->jenis_jra}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="nama dokumen" required value="{{$data->nama_dokumen}}">
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="deskripsi" required>{{$data->deskripsi}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Kurun Waktu</label>
                                    <input type="date" class="form-control" id="kurunWaktu" name="kurunWaktu" placeholder="tahun" required value="{{$data->kurun_waktu}}">
                                </div>
