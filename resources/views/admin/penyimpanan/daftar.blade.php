                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('admin/detil-dokumen/'.$data->id)}}" class="on-default edit-row">
                                        <i class="fa fa-eye" ></i>
                                    </a>
                                <a>/</a>
                                <a href="{{url('admin/edit-dokumen/'.$data->id)}}" class="on-default edit-row">
                                    <i class="fa fa-pencil" ></i>
                                </a>
                                <a>/</a>
                                <a href="{{url('admin/hapus-dokumen/'.$data->id)}}" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                        @endforeach
